...
const ProgrammaPage: React.FC = () => {
  ...
  const events = [
    { time: "10:00", title: "Cerimonia", description: "Presso la Chiesa di San Giovanni", icon: <ChurchIcon sx={{color:'#6A9C89'}} /> },
    { time: "12:00", title: "Aperitivo", description: "Presso la Locanda dei Sposini - Giardino Esterno", icon: <LocalBarIcon sx={{color:'#6A9C89'}}  /> },
    { time: "13:00", title: "Pranzo Nuziale", description: "Presso la Locanda dei Sposini - Sala Principale", icon: <RestaurantIcon sx={{color:'#6A9C89'}} /> },
    { time: "17:00", title: "Taglio della Torta & After Party", description: "Presso la Locanda dei Sposini - Area Lounge", icon: <CelebrationIcon sx={{color:'#6A9C89'}} /> },
  ];
  ...
  return (
    <Box component="article" sx={{backgroundColor: '#FFF5E4'}}> {/* Main page container, using article for semantics */}
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            component="p"
            sx={{
              color: 'rgba(193, 216, 195, 0.8)', // Slightly off-white for sub-heading
      ...
      <Container maxWidth="md" sx={{ pt: { xs: 2, sm: 3, md: 4 }, pb: { xs: 4, sm: 6, md: 8 } }}>
        <Typography variant="h4" component="h2" textAlign="center" color='#6A9C89'  sx={{ mb: { xs: 4, sm: 6 } }}>
      ...
      <Container maxWidth="md" sx={{ pt: { xs: 4, sm: 5, md: 6 }, pb: { xs: 2, sm: 3, md: 4 } }}>
        <Typography variant="h4" component="h2" textAlign="center" color='#6A9C89'  sx={{ mb: { xs: 2, sm: 3 } }}>
